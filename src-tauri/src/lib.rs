...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::kb_scan::kb_scan_files,
            commands::kb_scan::kb_write_file,
            commands::kb_scan::kb_get_file_info,
            commands::lark_cli::lark_cli_auth_login,
            commands::lark_cli::lark_cli_docs_create,
            commands::lark_cli::lark_cli_docs_fetch,
            commands::lark_cli::lark_cli_docs_update,
            commands::lark_cli::lark_cli_docs_search,
            commands::lark_cli::lark_cli_drive_list,
            commands::lark_cli::lark_cli_drive_upload,
            commands::lark_cli::lark_cli_drive_download,
            commands::lark_cli::lark_cli_markdown_create,
            commands::lark_cli::lark_cli_markdown_fetch,
            commands::lark_cli::lark_cli_markdown_overwrite,
            commands::lark_cli::lark_cli_wiki_list,
            commands::lark_cli::lark_cli_wiki_create_node,
